...
class Derivative(ft3.Object):
	...
	forward_ref_union_field: ft3.Field[
		'float | int | tuple[int | float, ...]'
	] = 2  # noqa
...
class DubDeriv(Derivative):
	...
	other_field: ft3.Field[lib.t.Optional[str]] = ft3.Field(
		default='Paul', enum=['Paul'], type_=lib.t.Optional[str]
	)
...
class MixinDeriv(ft3.Object):
	...
	other_field: ft3.Field[lib.t.Optional[str]] = ft3.Field(
		default='Albert', enum=['Albert'], type_=lib.t.Optional[str]
	)
